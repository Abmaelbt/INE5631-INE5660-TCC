...
\autor{\brazilword{Abmael Batista da Silva}}
\titulo{\lang{AIOps System for Monitoring and Root Cause Analysis of Incidents in\protect\\Cloud Servers using LLMs}{Sistema de AIOPS para Monitoramento e Análise de Causa Raiz de\protect\\Incidentes em Servidores Cloud com LLMs}}

% FIXME: Se houver subtítulo, descomente a linha abaixo
% \subtitulo{\lang{Subtitle}{Subtítulo}}

\orientador[\lang{Supervisor}{Orientador}]{\brazilword{Prof. Carlos Becker Westphall, Dr.}}
...
\data{\lang{30 of November of}{30 de Novembro de} 2026}
...
\palavraschaveufsc{palavraschaveingles}   {AIOps}
\palavraschaveufsc{palavraschaveportugues}{AIOps}

\palavraschaveufsc{palavraschaveingles}   {Large Language Models}
\palavraschaveufsc{palavraschaveportugues}{Modelos de Linguagem de Grande Escala}

\palavraschaveufsc{palavraschaveingles}   {Root Cause Analysis}
\palavraschaveufsc{palavraschaveportugues}{Análise de Causa Raiz}

\palavraschaveufsc{palavraschaveingles}   {Observability}
\palavraschaveufsc{palavraschaveportugues}{Observabilidade}

\palavraschaveufsc{palavraschaveingles}   {Retrieval-Augmented Generation}
\palavraschaveufsc{palavraschaveportugues}{Geração com Recuperação Aumentada}
...
% PARTE (removida para não exibir no sumário)
