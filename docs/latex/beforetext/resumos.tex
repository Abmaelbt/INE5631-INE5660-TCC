...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{resumo}[Resumo]
        ...
        A crescente complexidade das infraestruturas de computação em nuvem tem impulsionado a necessidade de mecanismos mais autônomos e inteligentes para o diagnóstico de incidentes. As abordagens tradicionais de monitoramento frequentemente exigem esforço manual extensivo para correlacionar métricas e registros do sistema durante falhas. Para mitigar esse desafio, este trabalho propõe e avalia uma arquitetura de integração entre plataformas de observabilidade e modelos de linguagem de grande escala, visando a automação da análise de causa raiz de problemas em ambientes virtuais. O sistema desenvolvido atua de forma orientada a eventos, interceptando alertas de monitoramento, consolidando o contexto do incidente por meio da extração automática de telemetria histórica e registros estruturados, e submetendo essas informações para inferência. A pesquisa explora diferentes técnicas de estruturação de contexto, comparando o desempenho e a aplicabilidade da execução de modelos locais em relação ao uso de serviços comerciais. A validação da proposta é conduzida por meio de testes simulados envolvendo falhas comuns de infraestrutura, avaliando-se a precisão e a qualidade diagnóstica dos relatórios gerados. Os resultados demonstram o potencial das ferramentas generativas para otimizar as operações de tecnologia da informação, oferecendo diagnósticos precisos e resguardando a privacidade dos dados ao viabilizar execuções em infraestrutura própria.
...
\newcommand{\imprimirenglishabstract}{%
    ...
    \begin{resumo}[Abstract]
        ...
        The growing complexity of cloud computing infrastructures has driven the need for more autonomous and intelligent mechanisms for incident diagnosis. Traditional monitoring approaches often require extensive manual effort to correlate metrics and system logs during failures. To mitigate this challenge, this work proposes and evaluates an integration architecture between observability platforms and large language models, aiming at the automation of root cause analysis for problems in virtual environments. The developed system acts in an event-driven manner, intercepting monitoring alerts, consolidating the incident context through the automatic extraction of historical telemetry and structured logs, and submitting this information for inference. The research explores different techniques for structuring context, comparing the performance and applicability of executing local models against the use of commercial services. The validation of the proposal is conducted through simulated tests involving common infrastructure failures, evaluating the accuracy and diagnostic quality of the generated reports. The results demonstrate the potential of generative tools to optimize information technology operations, offering precise diagnostics while safeguarding data privacy by enabling executions on proprietary infrastructure.
